...
| Category | Tools |
|---|---|
| **Automation** | Java, Selenium WebDriver, TestNG, Maven, Playwright (Python) |
| **CI/CD** | Jenkins, Selenium Grid, Git, GitHub Actions |
| **AI Tools** | Claude Code, GitHub Copilot (familiarity) |
